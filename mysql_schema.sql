...
CREATE TABLE `dimension_dictionaries` (
  ...
  `estimated_hours` DECIMAL(8,2) NULL COMMENT '三级分类预估工时',
  `contribution_points` DECIMAL(10,2) NULL COMMENT '三级分类积分',
...
CREATE TABLE `requirements` (
  ...
  `tertiary_category_codes_json` TEXT NULL COMMENT '多选三级分类代码快照',
  `status` VARCHAR(32) NOT NULL,
  `priority` VARCHAR(32) NULL,
...
CREATE TABLE `requirement_items` (
  ...
  `contribution_points` DECIMAL(10,2) NOT NULL DEFAULT 0,
  `status` VARCHAR(32) NOT NULL,
...
CREATE TABLE `tasks` (
  ...
  `contribution_points` DECIMAL(10,2) NOT NULL DEFAULT 0 COMMENT '任务积分快照',
...
CREATE TABLE `quotations` (
  ...
  `project_id` CHAR(36) NOT NULL,
  `customer_code` VARCHAR(32) NOT NULL,
  `contract_start_month` VARCHAR(7) NULL,
  `contract_end_month` VARCHAR(7) NULL,
  `status` VARCHAR(32) NOT NULL,
  ...
  KEY `idx_quotations_customer_contract_month` (`customer_code`, `contract_start_month`, `contract_end_month`),
